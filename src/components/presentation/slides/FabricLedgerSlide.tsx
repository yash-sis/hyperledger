      ...
      <div className="flex-1 grid grid-cols-2 gap-6">
        <div>
          ...
          <div className="p-4 bg-white border border-gray-200 rounded-lg">
            ...
            <div className="space-y-2">
              <DiagramBox title="SOLO" color="bg-yellow-100 border-yellow-300" className="p-2 text-left">
                <p>Single orderer node - for development only</p>
              </DiagramBox>
              <DiagramBox title="Kafka" color="bg-yellow-100 border-yellow-300" className="p-2 text-left">
                <p>CFT solution using Apache Kafka (deprecated)</p>
              </DiagramBox>
              <DiagramBox title="Raft (Recommended)" color="bg-green-100 border-green-300" className="p-2 text-left">
                <p>CFT implementation with leader election</p>
              </DiagramBox>
              <DiagramBox title="PBFT" color="bg-yellow-100 border-yellow-300" className="p-2 text-left">
          ...
          <div className="p-4 bg-white border border-gray-200 rounded-lg mt-4">
            ...
            <div className="space-y-2">
              <div className="text-sm mb-2">Built using gRPC and Protocol Buffers</div>
              <div className="grid grid-cols-2 gap-2">
                <DiagramBox title="Discovery" color="bg-blue-50 border-blue-200" />
                <DiagramBox title="Transaction" color="bg-blue-50 border-blue-200" />
                <DiagramBox title="Consensus" color="bg-blue-50 border-blue-200" />
                <DiagramBox title="Synchronization" color="bg-blue-50 border-blue-200" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-2">
          ...
          <div className="grid grid-cols-2 gap-6">
            <DiagramBox title="LevelDB (Default)" color="bg-purple-100 border-purple-300" className="p-4 text-left">
            ...
            <DiagramBox title="CouchDB (Rich Queries)" color="bg-purple-100 border-purple-300" className="p-4 text-left">
              <ul className="list-disc pl-5 space-y-1">
