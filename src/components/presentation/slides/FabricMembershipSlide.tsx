...
import { ArchitectureDiagram, DiagramBox, ComparisonChart } from '../DiagramComponents';
      ...
      <div className="flex-1 grid grid-cols-2 gap-6">
        <div>
          ...
          <div className="space-y-2">
            <DiagramBox title="Fabric CA" color="bg-green-100 border-green-300" className="p-3 text-left">
              <p>Built-in CA for development and testing</p>
            </DiagramBox>
            
            <DiagramBox title="External CA" color="bg-green-100 border-green-300" className="p-3 text-left">
          ...
          <ArchitectureDiagram title="MSP Workflow" className="mt-6">
            <div className="grid grid-cols-3 gap-2 p-2">
              <DiagramBox title="User/Peer" color="bg-yellow-100 border-yellow-300" />
              ...
              <div className="col-span-3 text-center text-xs text-gray-500 my-1">Certificate Issuance</div>
              <div className="col-span-3">
                <DiagramBox title="MSP" color="bg-blue-100 border-blue-300" className="p-3">
                  <p>Validates and authenticates transaction signatures</p>
                </DiagramBox>
              </div>
              <div className="col-span-3 text-center text-xs text-gray-500 my-1">Identity Verification</div>
              <DiagramBox title="Channel" color="bg-purple-100 border-purple-300" className="col-span-3" />
            </div>
          </ArchitectureDiagram>
        </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-white border border-gray-200 rounded-lg">
              ...
              <ul className="space-y-2">
                ...
                <li className="bullet-point">Signature generation and verification</li>
                <li className="bullet-point">User credential management</li>
                <li className="bullet-point">Authentication for all blockchain operations</li>
              </ul>
            </div>
            ...
            <div className="p-4 bg-white border border-gray-200 rounded-lg">
              ...
              <div className="space-y-2">
                <DiagramBox title="Local MSP" color="bg-indigo-100 border-indigo-300" className="p-2 text-left">
                  Defines the permissions of nodes (peers, orderers)
                </DiagramBox>
                <DiagramBox title="Channel MSP" color="bg-indigo-100 border-indigo-300" className="p-2 text-left">
