            ...
            <div className="lifecycle-timeline">
              ...
              <div className="timeline-stage">
                ...
                <div className="stage-content">
                  ...
                  <p className="text-sm text-gray-600">Project idea submission</p>
                </div>
              </div>
              ...
              <div className="timeline-stage">
                ...
                <div className="stage-content">
                  ...
                  <p className="text-sm text-gray-600">Working code + community participation</p>
                </div>
              </div>
              ...
              <div className="timeline-stage">
                ...
                <div className="stage-content">
                  ...
                  <p className="text-sm text-gray-600">Stable project meeting release criteria</p>
                </div>
              </div>
              ...
              <div className="timeline-stage">
                ...
                <div className="stage-content">
                  ...
                  <p className="text-sm text-gray-600">Project no longer maintained</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="community-stat flex items-center p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Organizations Contributing</div>
                <div className="text-xs text-gray-500 mt-1">IBM, Intel, Accenture, and more</div>
              </div>
            </div>
            ...
            <div className="community-stat flex items-center p-4 bg-purple-50 rounded-lg border border-purple-200">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Worldwide meetups & events</div>
              </div>
            </div>
