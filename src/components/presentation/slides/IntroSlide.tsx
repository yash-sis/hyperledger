      ...
      <div className="relative z-10">
        ...
        <div className="max-w-3xl mx-auto bg-white/80 backdrop-blur-sm rounded-lg p-6 border border-gray-200 shadow-sm mb-8">
          <p className="text-xl text-center mb-6">
            <span className="font-semibold">Not a blockchain</span>, but an
            open-source umbrella project launched by the Linux Foundation in
            2015
          </p>
          ...
          <div className="grid grid-cols-1 gap-4 mb-4">
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
              <p className="text-lg">
                Goal: Foster collaborative development of{" "}
          ...
          <div className="flex justify-center">
            ...
            >
              <div className="flex flex-wrap justify-center gap-3 mt-2">
                ...
                <span className="px-3 py-1 bg-yellow-100 rounded-full text-yellow-800">
