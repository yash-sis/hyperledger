  ...
  return (
    <div className="slide-content">
      ...
      <p className="text-center text-lg mb-6">
        Libraries offer shared services across distributed ledger technology projects
      </p>
        ...
        <div className="libraries-scroll">
          <div className="library-card">
            ...
            <div className="card-content">
              ...
              <p className="text-gray-600 mb-2">Decentralized identity infrastructure</p>
          ...
          <div className="library-card">
            ...
            <div className="card-content">
              ...
              <p className="text-gray-600 mb-2">Interledger protocol implementation</p>
              <ul className="text-sm text-gray-700">
          ...
          <div className="library-card">
            ...
            <div className="card-content">
              ...
              <p className="text-gray-600 mb-2">Blockchain integration framework</p>
              <ul className="text-sm text-gray-700">
      ...
      <div className="mt-8 bg-gray-100 p-4 rounded-lg border border-gray-200">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center p-2 bg-white rounded shadow-sm">
            ...
            <div className="text-sm text-gray-600">Shared code across frameworks</div>
          </div>
          <div className="text-center p-2 bg-white rounded shadow-sm">
            <div className="font-medium mb-1">Specialization</div>
            <div className="text-sm text-gray-600">Focused on single concern</div>
          </div>
          <div className="text-center p-2 bg-white rounded shadow-sm">
            <div className="font-medium mb-1">Standardization</div>
            <div className="text-sm text-gray-600">Common APIs and interfaces</div>
          </div>
        </div>
      </div>
    </div>
