    ...
    <div className="slide-content">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="ecosystem-tree max-w-4xl w-full">
          ...
          <div className="tree-root">
            <DiagramBox title="Hyperledger" color="bg-blue-100 border-blue-300" className="mx-auto w-64 py-3">
              <div className="text-sm">Modular, collaborative blockchain ecosystem</div>
            </DiagramBox>
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="tree-branch flex flex-col items-center">
                <DiagramBox title="Ledgers" color="bg-green-100 border-green-300" className="w-full mb-2">
              ...
              {/* Libraries */}
              <div className="tree-branch flex flex-col items-center">
                <DiagramBox title="Libraries" color="bg-yellow-100 border-yellow-300" className="w-full mb-2">
                  Shared components
                </DiagramBox>
                <div className="tree-items space-y-1 w-full">
              ...
              {/* Tools */}
              <div className="tree-branch flex flex-col items-center">
                <DiagramBox title="Tools" color="bg-purple-100 border-purple-300" className="w-full mb-2">
                  Development support
                </DiagramBox>
                <div className="tree-items space-y-1 w-full">
              ...
              {/* Domain */}
              <div className="tree-branch flex flex-col items-center">
                <DiagramBox title="Domain" color="bg-red-100 border-red-300" className="w-full mb-2">
                  Industry solutions
                </DiagramBox>
                <div className="tree-items space-y-1 w-full">
      ...
      <div className="mt-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 max-w-2xl mx-auto">
          <h3 className="font-medium text-lg mb-2 text-center">Key Ecosystem Benefits</h3>
          ...
          <div className="mt-3 text-center">
            <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-blue-100 to-green-100 rounded-full text-sm font-medium">
              ...
              <span className="ml-2 text-blue-600">→ Adoption & Innovation</span>
            </div>
          </div>
        </div>
      </div>
